    ...
    <AnimatedPage className="min-h-screen bg-slate-50 flex flex-col p-4 pt-6 pb-16">
      <div className="flex-1 flex flex-col max-w-sm mx-auto w-full">
        ...
        <div className="text-center mb-5">
          ...
          <h1 className="text-base font-bold text-slate-900 tracking-tight">Service Sign-Off</h1>
          <p className="text-xs text-slate-500 mt-0.5">Please inspect the completed work</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 border border-slate-200/90 shadow-2xs space-y-3 mb-4">
          ...
          <div className="pt-1 space-y-1.5 text-xs text-slate-600">
            <div className="flex items-center gap-2">
              ...
              <span>Task executed according to specifications</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-emerald-600 font-bold">✓</span>
              <span>Worksite cleaned & restored</span>
            </div>
          </div>
